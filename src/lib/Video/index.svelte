...
<div class="video" on:click={showIframe}>
  {#if iframePlaceholder}
    <picture>
      <source srcset="https://i.ytimg.com/vi_webp/{id}/maxresdefault.webp" type="image/webp" />
      <img class="video__media" src="https://i.ytimg.com/vi/{id}/maxresdefault.jpg" alt={title} />
    </picture>
    <button class="video__button">
      <svg width="68" height="48" viewBox="0 0 68 48">
        ...
        <path class="video__button-icon" d="M 45,24 27,14 27,34" />
      </svg>
    </button>
  {:else}
    <iframe
