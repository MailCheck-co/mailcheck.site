  ...
  <div class="wrapper-cost">
    <ul
      ...
      <li class="card" id="agency">
        ...
        <a href="//app.mailcheck.co/dashboard/payment_plans" class="btn btn-choose btn-cyan"
          >choose</a>
      </li>
      <li class="card" id="enterprise">
        ...
        <a href="//app.mailcheck.co/dashboard/payment_plans" class="btn btn-choose btn-grey"
          >choose</a>
      </li>
      <li class="card" id="custom">
        ...
        <a href="//app.mailcheck.co/dashboard/payment_plans" class="btn btn-choose btn-red"
          >choose</a>
      </li>
    </ul>
  </div>
