  ...
  <div class="container">
    <div class="content-block">
      ...
      <p class="text-thin terms-text">
        Thank you for choosing to be part of our community at OSA Management
        LLP, doing business as Mailcheck (“Mailcheck”, “we”, “us”, or “our”). We
      ...
      <p class="text-thin terms-text">
        ...
        this privacy policy carefully as it will help you make informed
      ...
      <p class="text-thin terms-text">
        ...
        information, passwords and security data, payment information, and
        social media login data. We collect personal information that you
        voluntarily provide to us when registering at the Sites expressing an
        interest in obtaining information about us or our products and services,
        when participating in activities on the Sites or otherwise contacting
        ...
        include the following: Name and Contact Data. We collect your first and
        last name, email address, postal address, phone number, and other
        similar contact data. Credentials. We collect passwords, password hints,
        and similar security information used for authentication and account
        access. Payment Data. We collect data necessary to process your payment
        ...
        instrument. All payment data is stored by our payment processor Stripe
        and you should review its privacy policies and contact the payment
        processor directly to respond to your questions
        <a class="text-thin text-thin-link" href="https://stripe.com/privacy"
          >stripe.com/privacy</a
        >. Social Media Login Data. We provide you with the option to register
        using social media account details, like your Facebook, Google. If you
      ...
      <p class="text-thin terms-text">
        ...
        Facebook, Google), as well as from other third parties. Examples of the
      ...
      <p class="text-thin terms-text">
        ...
        those third parties to facilitate account creation and login process.
      ...
      <p class="text-thin terms-text">
        ...
        information to provide you with service and new feature information
      ...
      <p class="text-thin terms-text">
        To protect our Site. We may use your information as part of our efforts
        to keep our Site safe and secure (for example, for fraud monitoring and
        prevention).
      </p>
      ...
      <p class="text-thin terms-text">
        ...
        evaluate and improve our Site, product, services, marketing and your
        experience.
      </p>
      ...
      <p class="text-thin terms-text">
        ...
        revoke your consent, please contact us s@mailcheck.co.
      </p>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">
        ...
        concerned, but will often include Your name, email address, profile
        picture, language preference, gender, birthday, location, other info
        published on Facebook, Google.
      </p>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">
        ...
        of Use and/or comply with legal requirements. Cookies and similar
        ...
        cookies, this could affect certain features or services of our Sites. To
        opt-out of interest-based advertising by advertisers on our Sites visit
        <a
          class="text-thin text-thin-link"
