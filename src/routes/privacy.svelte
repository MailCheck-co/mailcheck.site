  ...
  <div class="container">
    <div class="content-block">
      ...
      <p class="text-thin terms-text">
        Thank you for choosing to be part of our community at OSA Management LLP, doing business as
        Mailcheck (“Mailcheck”, “we”, “us”, or “our”). We are committed to protecting your personal
        ...
        s@mailcheck.co. When you visit our website
        <a sveltekit:prefetch class="text-thin text-thin-link" href="/">mailcheck.co</a>, and use
      ...
      <p class="text-thin terms-text">
        ...
        <a sveltekit:prefetch class="text-thin text-thin-link" href="/">mailcheck.co</a>), and/or
        any related services, sales, marketing or events (we refer to them collectively in this
        privacy policy as the "Sites"). Please read this privacy policy carefully as it will help
      ...
      <h2 class="text-thin subtitle">1. WHAT INFORMATION DO WE COLLECT?</h2>

      <p class="text-thin terms-text">
        Personal information you disclose to us In Short: We collect personal information that you
        provide to us such as name, address, contact information, passwords and security data,
        payment information, and social media login data. We collect personal information that you
        voluntarily provide to us when registering at the Sites expressing an interest in obtaining
        information about us or our products and services, when participating in activities on the
        Sites or otherwise contacting us. The personal information that we collect depends on the
        context of your interactions with us and the Sites, the choices you make and the products
        and features you use. The personal information we collect can include the following: Name
        and Contact Data. We collect your first and last name, email address, postal address, phone
        number, and other similar contact data. Credentials. We collect passwords, password hints,
        and similar security information used for authentication and account access. Payment Data.
        ...
        with your payment instrument. All payment data is stored by our payment processor Stripe and
        you should review its privacy policies and contact the payment processor directly to respond
        to your questions
        <a class="text-thin text-thin-link" href="https://stripe.com/privacy">stripe.com/privacy</a
        >. Social Media Login Data. We provide you with the option to register using social media
        account details, like your Facebook, Google. If you choose to register in this way, we will
        collect the Information described in the section called "HOW DO WE HANDLE YOUR SOCIAL
      ...
      <p class="text-thin terms-text">Information automatically collected</p>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">Information collected from other sources</p>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">
        ...
        marketing partners, social media platforms (such as Facebook, Google), as well as from other
        ...
        country, user identification numbers for your contacts, profile picture URL and any other
        information that you choose to make public); marketing leads and search results and links,
        including paid listings (such as sponsored links).
      </p>
      <h2 class="text-thin subtitle">2. HOW DO WE USE YOUR INFORMATION?</h2>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">We use the information we collect or receive:</p>
      <p class="text-thin terms-text">
        To facilitate account creation and login process. If you choose to link your account with us
        to a third party account *(such as your Google or Facebook account), we use the information
        you allowed us to collect from those third parties to facilitate account creation and login
        process. See the section below headed "HOW DO WE HANDLE YOUR SOCIAL LOGINS" for further
        information.
      </p>
      <p class="text-thin terms-text">
        To send administrative information to you. We may use your personal information to provide
        you with service and new feature information and/or information about changes to our terms,
        conditions, and policies.
      </p>

      <p class="text-thin terms-text">
        Fulfill and manage your orders. We may use your information to fulfill and manage your
        orders, payments, returns, and exchanges made through the Site.
      </p>

      <p class="text-thin terms-text">
        To protect our Site. We may use your information as part of our efforts to keep our Site
        safe and secure (for example, for fraud monitoring and prevention).
      </p>

      <p class="text-thin terms-text">To enforce our terms, conditions and policies.</p>
      ...
      <p class="text-thin terms-text">
        ...
        campaigns and to evaluate and improve our Site, product, services, marketing and your
        experience.
      </p>
      <h2 class="text-thin subtitle">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h2>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">
        ...
        time. This information may be used to, among other things, analyze and track data, determine
        the popularity of certain content and better understand online activity. Unless described in
      ...
      <h2 class="text-thin subtitle">4. WHO WILL YOUR INFORMATION BE SHARED WITH?</h2>
      ...
      <p class="text-thin terms-text">
        ...
        and you wish to revoke your consent, please contact us s@mailcheck.co.
      </p>
      <p class="text-thin terms-text">Allow Users to Connect to their Third-Party Accounts:</p>
      <p class="text-thin terms-text">Facebook account and Google account</p>
      ...
      <p class="text-thin terms-text">Functionality and Infrastructure Optimization:</p>
      ...
      <p class="text-thin terms-text">Use of Facebook Pixels, Google Ad</p>

      <h2 class="text-thin subtitle">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
      <p class="text-thin terms-text">
      ...
      <h2 class="text-thin subtitle">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
      <p class="text-thin terms-text">
        In Short: If you choose to register or log in to our websites using a social media account,
        we may have access to certain information about you.
      </p>
      <p class="text-thin terms-text">
        Our Sites offer you the ability to register and login using your third party social media
        account details (like your Facebook or Google logins). Where you choose to do this, we will
        ...
        often include Your name, email address, profile picture, language preference, gender,
        birthday, location, other info published on Facebook, Google.
      </p>
      <p class="text-thin terms-text">
        We will use the information we receive only for the purposes that are described in this
        privacy policy or that are otherwise made clear to you on the
        <a sveltekit:prefetch class="text-thin text-thin-link" href="/">mailcheck.co</a>. Please
        ...
        privacy policy to understand how they collect, use and share your personal information, and
        how you can set your privacy preferences on their sites and apps.
      </p>
      <h2 class="text-thin subtitle">7. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h2>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">
        The Sites may contain advertisements from third parties that are not affiliated with us and
      ...
      <h2 class="text-thin subtitle">8. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
      <p class="text-thin terms-text">
      ...
      <h2 class="text-thin subtitle">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
      <p class="text-thin terms-text">
      ...
      <h2 class="text-thin subtitle">10. DO WE COLLECT INFORMATION FROM MINORS?</h2>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">
        ...
        please contact us at s@mailcheck.co.
      </p>
      <h2 class="text-thin subtitle">11. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
      <p class="text-thin terms-text">
      ...
      <ul class="text-thin terms-text">
        ...
        <li>User can contact support team in order to delete an account</li>
      </ul>
      <p class="text-thin terms-text">
        ...
        Terms of Use and/or comply with legal requirements. Cookies and similar technologies: Most
        Web browsers are set to accept cookies by default. If you prefer, you can usually choose to
        set your browser to remove cookies and to reject cookies. If you choose to remove cookies or
        reject cookies, this could affect certain features or services of our Sites. To opt-out of
        interest-based advertising by advertisers on our Sites visit
        <a class="text-thin text-thin-link" href="http://www.aboutads.info/choices/"
      ...
      <h2 class="text-thin subtitle">12. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
      <p class="text-thin terms-text">
      ...
      <h2 class="text-thin subtitle">13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
      <p class="text-thin terms-text">
        ...
        a registered account with the Sites, you have the right to request removal of unwanted data
        that you publicly post on the Sites. To request removal of such data, please contact us
        using the contact information provided below, and include the email address associated with
        your account and a statement that you reside in California. We will make sure the data is
        not publicly displayed on the Sites, but please be aware that the data may not be completely
        or comprehensively removed from our systems.
      </p>
      <h2 class="text-thin subtitle">14. DO WE MAKE UPDATES TO THIS POLICY?</h2>
      <p class="text-thin terms-text">
      ...
      <h2 class="text-thin subtitle">15. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</h2>
      <p class="text-thin terms-text">
        If you have questions or comments about this policy, you may email us at s@mailcheck.co or
        by post to:
      </p>
