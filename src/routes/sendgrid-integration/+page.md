...
![sendgrid email verification integration](./Sendgrid-1.jpg?enhanced)

### Step 2

Copy API key from your Sendgrid account - go to “Settings” in SendGrid and find “API Keys” hit “Create a key”

![find api keys ](./Sendgrid-2.jpg?enhanced)

![hit create api key](./Sendgrid-2-1.jpg?enhanced)

### Step 3

Name your API Key and choose the API Key Permissions

![sendgrid API Key Permissions](./Sendgrid-3.jpg?enhanced)
...
![choose access rights ](./Sendgrid-5.jpg?enhanced)

### Step 6

Don’t forget to copy your key - this action won’t be repeated

![copy api key](./Sendgrid-6.jpg?enhanced)
...
![connect Mailchimp to Sendgrid](./Sendgrid-7.jpg?enhanced)

### Step 8

If everything goes well, you’ll see three buttons

![sendgrid integration buttons](./Sendgrid-8.jpg?enhanced)
...
![choosing validation option](./Sendgrid-10.jpg?enhanced)

### Step 11

Hit “Process” to get it rolling

![start email validation session](./Sendgrid-11.jpg?enhanced)
...
![Sendgrid validation contact details](./Sendgrid-13-1.jpg?enhanced)

![Sendgrid validation detailed info](./Sendgrid-13-2.jpg?enhanced)
...
![filter validated data](./Sendgrid-14-1.jpg?enhanced)
...
![create list segments](./Sendgrid-14-2.jpg?enhanced)
...
![choose targeting](./Sendgrid-17.jpg?enhanced)
