    ...
    <div class="accordion">
      <div class="accordion-column">
        <div class="tab">
          ...
          <div class="tab-content">
            <p class="tab-text">
              ...
              networks, and open databases available online.
            </p>
          </div>
        </div>
        ...
        <div class="tab">
          ...
          <label class="tab-label" for="radio2"
            >What social networks do you use for validation?</label>
          <div class="tab-content">
            <p class="tab-text">
        ...
        <div class="tab">
          ...
          <label class="tab-label" for="radio3"
            >What is your difference from the competitors?</label>
          <div class="tab-content">
            <p class="tab-text">
              The main difference from our competitors is that we do not use
              only the automatic search and validation but we provide manual
              moderation, so we use all the power of social networks and search
              engines for more in-depth validation.
            </p>
          </div>
        </div>
        ...
        <div class="tab">
          ...
          <div class="tab-content">
            <p class="tab-text">
              ...
              10 emails FOR FREE without adding a payment method and increase
              the number of verifications up to 100 emails with the payment
              method added.
            </p>
          </div>
        </div>
        ...
        <div class="tab">
          <input
            ...
            id="radio5"
            name="acc-tabs" />
          <label class="tab-label" for="radio5"
            >Do you check phone numbers?</label>
          <div class="tab-content">
            <p class="tab-text">
        ...
        <div class="tab">
          ...
          <label class="tab-label" for="radio6"
            >How to get started with Mailcheck?</label>
          <div class="tab-content">
            <p class="tab-text">
              Step 1<br />
        ...
        <div class="tab">
          ...
          <label class="tab-label" for="radio7"
            >How to get verified your first list?</label>
          <div class="tab-content">
            <p class="tab-text">
              Step 1<br />
          ...
          <div class="tab-content">
            <p class="tab-text">
              * Emails with a trust rate of 0-49% are Risky and most likely
              INVALID, we don't recommend using them<br />
        ...
        <div class="tab">
          <input
            ...
            id="radio11"
            name="acc-tabs" />
          <label class="tab-label" for="radio11"
            >How to delete an account at Mailcheck?</label>
          <div class="tab-content">
            <p class="tab-text">
        ...
        <div class="tab">
          ...
          <div class="tab-content">
            <p class="tab-text">
              ...
              delimiter, we ask to set it in order to validate the chosen
              column, NOTE it only has to be an email column
            </p>
          </div>
        </div>
        ...
        <div class="tab">
          <input
            ...
            id="radio13"
            name="acc-tabs" />
          <label class="tab-label" for="radio13"
            >How to prepare a list to get it verified?</label>
          <div class="tab-content">
            <p class="tab-text">
              If you data in Google Sheets or Excel you can export them to .csv
              and upload to your Mailcheck account
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="accordion-column">
        <div class="tab">
          ...
          <div class="tab-content">
            <p class="tab-text">
              All information about our users is protected by Google systems, we
              do really care about privacy and that's why never share any data
              due to the GDPR compliance.
            </p>
          </div>
        </div>
        ...
        <div class="tab">
          ...
          <div class="tab-content">
            <p class="tab-text">
              ...
              verified, and 10 free email validations if the payment details
              weren't provided<br />
        ...
        <div class="tab">
          <input
            ...
            id="radio16"
            name="acc-tabs" />
          <label class="tab-label" for="radio16"
            >What is a quick validation?</label>
          <div class="tab-content">
            <p class="tab-text">
              Quick validation aimed to help our customers to verify a single
        ...
        <div class="tab">
          <input
            ...
            id="radio17"
            name="acc-tabs" />
          <label class="tab-label" for="radio17"
            >Downloading Verified Lists</label>
          <div class="tab-content">
            <p class="tab-text">
        ...
        <div class="tab">
          <input
            ...
            id="radio19"
            name="acc-tabs" />
          <label class="tab-label" for="radio19"
            >How does Mailcheck work?</label>
          <div class="tab-content">
            <p class="tab-text">
        ...
        <div class="tab">
          <input
            ...
            id="radio20"
            name="acc-tabs" />
          <label class="tab-label" for="radio20"
            >What is the overuse charge?</label>
          <div class="tab-content">
            <p class="tab-text">
              Since Mailcheck doesn't set any limits for the verification we
              allow our clients under the paid subscriptions to verify as many
              emails as they can, overuse charge applies when the plan limited
              was used up. For example, the overuse charge for the PRO = $0.005
              Agency = $0.004 Enterprise = $0.003 The bigger plan you choose the
              lower overuse charge can be
            </p>
          </div>
        </div>
        ...
        <div class="tab">
          <input
            ...
            id="radio22"
            name="acc-tabs" />
          <label class="tab-label" for="radio22"
            >How can I cancel my subscription?</label>
          <div class="tab-content">
            <p class="tab-text">
        ...
        <div class="tab">
          <input
            ...
            id="radio24"
            name="acc-tabs" />
          <label class="tab-label" for="radio24"
            >Why I can't see a dark mode option on my account?</label>
          <div class="tab-content">
            <p class="tab-text">
              We apply Dark Mode only for those users who have purchased paid
              plans and planning to develop more features
            </p>
          </div>
        </div>
        ...
        <div class="tab">
          <input
            ...
            id="radio25"
            name="acc-tabs" />
          <label class="tab-label" for="radio25"
            >How long does usually take to verify 1M files?</label>
          <div class="tab-content">
            <p class="tab-text">
              It depends but usually takes around 20min-60min just because our
              innovative technology allows making in-depth validation and run
              the data through multiply sources making sure we give the most
              accurate answer.
            </p>
          </div>
        </div>
        <div class="tab">
          <input
            ...
            id="radio26"
            name="acc-tabs" />
          <label class="tab-label" for="radio26"
            >Mailchimp Integration instructions</label>
          <div class="tab-content">
            <p class="tab-text">
        ...
        <div class="tab">
          <input
            ...
            id="radio27"
            name="acc-tabs" />
          <label class="tab-label" for="radio27"
            >Zapier Integration instructions</label>
          <div class="tab-content">
            <p class="tab-text">
