...
![email list in spam](./easyspace.jpg?format=webp;jpg;png;avif&srcset&width=880)
...
![AppInstitute](./app-institute.jpg?format=webp;jpg;png;avif&srcset&width=880)

Source: AppInstitute

Email lists may contain emails of users who never subscribed to your newsletter, therefore chances are they will not open your emails and will not engage with it. Email lists also contain old emails that can no longer be active, [which will result in the increase of your bounce rate.](/blog/email-bounce-rate-explaining-and-reduceing) Even if a company that is selling you email lists claims (and it certainly will) it contains only high-quality data, chances are that data is irrelevant to your business, meaning that recipients will not be interested in the content of your emails, which will be followed by an increased unsubscribe rate.
...
![Spam filter](./easyspace.jpg?format=webp;jpg;png;avif&srcset&width=880)
...
## If you still want to buy email list
