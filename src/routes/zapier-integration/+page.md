...
description: Using Mailcheck with Zapier. Here is what you need. A step-by-step guide to integrating Mailcheck with daily services using Zapier
---
...
![Open your Zapier account and log in](./open-your-zapier-account-and-log-in.jpg?enhanced)

### Step 2:

You can add a name to your zap just click on **“Name your Zap”**.

![add a name to your zap](./add-a-name-to-your-zap.jpg?enhanced)

### Step 3:

On the **“Choose app & event”** section click on **“Google Sheets”**.

![add a name to your zap](./choose-app-google-sheets.jpg?enhanced)

### Step 4:

The next thing is to trigger **“New or Updated Spreadsheet Row”**, then tap **“Continue”**.

![trigger new or updated spreadsheet row](./trigger-new-or-updated-spreadsheet-row.jpg?enhanced)

### Step 5:

Tap **“Choose Account”** and connect your Google account to get your Google Sheet information

![choose google account](./choose-account-google.jpg?enhanced)

![connect your google account](./connect-your-google-account.jpg?enhanced)
...
![choose a spreadsheet you require for the validation](./choose-a-spreadsheet-you-require-for-the-validation.jpg?enhanced)
...
![test your zap trigger](./test-your-trigger.jpg?enhanced)

![check summary of the trigger setup](./summary-of-the-trigger-setup.jpg?enhanced)

### Step 8:

It is time to establish the Action. Please find “Mailcheck” in the search field and select it

![establish the action](./establish-the-action.jpg?enhanced)
...
![verify email address](./verify-email-address.jpg?enhanced)

### Step 10:

At this stage, you have to establish Mailcheck account, click **“Choose an account”** and click on **“connect a new account”**

![establish link to mailcheck account](./establish-link-to-mailcheck-account.jpg?enhanced)

![connect a new mailcheck account](./connect-a-new-mailcheck-account.jpg?enhanced)
...
![choose the right email data](./choose-the-right-email-data-from-the-drop-down-list.jpg?enhanced)

### Step 12:

You can turn on Zap and close or export the results back to Google Sheets

![turn on Zap](./turn-on-zap.jpg?enhanced)
...
![receive back the validation results](./receive-back-the-validation-results-to-the-google-sheet.jpg?enhanced)

### Step 14:

You need to choose Google Sheets again

![choose google sheets again](./choose-google-sheets-again.jpg?enhanced)
...
![setup the action](./setup-action.jpg?enhanced)
...
![choosing the row](./new-row.jpg?enhanced)

![choosing the row ID](./row-id.jpg?enhanced)

### Step 19:

Find **“Result”** field, click on **“verify email address in Mailcheck”** choose “Status” proceed with **“Continue”**

![insert data to form](./insert-data.jpg?enhanced)
...
![update spreadsheet row](./update-spreadsheet-row.jpg?enhanced)

### Step 22:

Let’s perform manual tests to ensure everything is working properly.

![perform manual tests](./perform-manual-tests.jpg?enhanced)
