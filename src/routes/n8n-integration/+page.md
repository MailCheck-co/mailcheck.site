...
![N8N integration step 1: Mailcheck integration page](./step-1.jpg?enhanced)

### Step 2:

Add new block and find in search Google Sheets

![N8N integration step 2: Find Google Sheets](./step-2.jpg?enhanced)
...
![N8N integration step 3: Fill out the data and click “Execute”](./step-3.jpg?enhanced)
...
![N8N integration step 4: Choose the right credentials](./step-4.jpg?enhanced)
...
![N8N integration step 5: Choose next node](./step-5.jpg?enhanced)

### Step 6:

Add new block, it is call “IF”

![N8N integration step 6: Add new block called “IF”](./step-6.jpg?enhanced)
...
![N8N integration step 7: Fill out the raw](./step-7.jpg?enhanced)
...
![N8N integration step 8: Choose node and trustRate](./step-8.jpg?enhanced)
...
![N8N integration step 8: Create new block SendGrid](./step-9.jpg?enhanced)

![N8N integration step 8: Click on Execute](./step-10.jpg?enhanced)
