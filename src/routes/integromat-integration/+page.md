...
![integromat email verification integration](./integromat-1.png?enhanced)
...
![integromat enable email verification](./integromat-2.png?enhanced)

### Step 3

- Choose the service you want to integrate with (Mailchimp, Google Sheet, ActiveCampaign, etc.)

![integromat integration options](./integromat-3.png?enhanced)
...
![integromat mailchimp integration](./integromat-4.png?enhanced)
...
![connect mailchimp to Integromat](./integromat-5.png?enhanced)
...
![email list choose in Integromat](./integromat-6.png?enhanced)
...
![connect Mailcheck to Integromat](./integromat-7.png?enhanced)

- Find Mailcheck to connect with the previous module

![choose api method in Integromat](./integromat-8.png?enhanced)

- Click on "+" and type "Mailcheck"
- Choose "Single Email check"

![validate email in Integromat](./integromat-9.png?enhanced)
...
![api key for email validation](./integromat-10.png?enhanced)

![validate email in integromat](./integromat-11.png?enhanced)

- Copy your API KEY and get back to Integromat to paste it

### Step 8

![Email from the modal window](./integromat-12.png?enhanced)

- Choose "Email from the modal window"

![update segment](./integromat-13.png?enhanced)
...
![connect Mailchimp to Integromat](./integromat-14.png?enhanced)
...
![update map option](./integromat-15.png?enhanced)
...
![email trust rate in Integromat](./integromat-16.png?enhanced)

### Step 12

- Run once

![run email validation in Integromat](./integromat-17.png?enhanced)
