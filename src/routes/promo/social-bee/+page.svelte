<script>
  import sassb from './sass-b.png?enhanced';
...
<main>
  <div class="row">
    ...
    <div class="col right">
      <enhanced:img src={sassb} alt="sassb" />
      <div class="field">
        <input
          ...
          value={promocode}
          disabled
          onkeydown={copyPromoCode}
          onmousedown={copyPromoCode}
        />
        <button type="button" class="btn-verify-email" onclick={copyPromoCode}>
          Copy Promocode
        </button>
      </div>
    </div>
