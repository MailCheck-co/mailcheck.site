  ...
  <div class="container">
    <div class="content-block">
      ...
      <p class="text-thin terms-text">
        ...
        connected thereto (collectively, the “Site”). You agree that by accessing
      ...
      <p class="text-thin terms-text">
        The Site is intended for users who are at least 18 years of age. All
      ...
      <p class="text-thin terms-text">
        ...
        are not under the age of 18; (5) you are not a minor in the jurisdiction
      ...
      <p class="text-thin terms-text">
        ...
        hosted in the United Kingdom. If you access the Site from any other
        ...
        the United Kingdom, then through your continued use of the Site, you are
        transferring your data to the United Kingdom, and you agree to have your
        data transferred to and processed in the United Kingdom. Further, we do
        ...
        that anyone under the age of 18 has provided personal information to us
      ...
      <p class="text-thin terms-text">
        ...
        provisions of the law of your country of residence. OSA MANAGEMENT LLP
        and yourself both agree to submit to the non-exclusive jurisdiction of
        the courts of England, London, which means that you may make a claim to
        defend your consumer protection rights in regards to these Conditions of
        Use in the United Kingdom, or in the EU country in which you reside.
      </p>
