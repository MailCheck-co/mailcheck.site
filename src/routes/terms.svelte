...
<Seo {desc} title="Terms and Conditions" noindex={true} />
...
<main class="terms" id="terms">
  <div class="container">
    <div class="content-block">
      ...
      <h2 class="text-thin subtitle">AGREEMENT TO TERMS</h2>

      <p class="text-thin terms-text">
        These Terms of Use constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity (“you”) and OSA MANAGEMENT LLP, doing business as
        Mailcheck ("Mailcheck", “we”, “us”, or “our”), concerning your access to and use of the <a
          sveltekit:prefetch
          class="text-thin text-thin-link"
          href="/">mailcheck.co</a> website as well as any other media form, media channel, mobile website
      ...
      <h2 class="text-thin subtitle">INTELLECTUAL PROPERTY RIGHTS</h2>
      ...
      <h2 class="text-thin subtitle">USER REPRESENTATIONS</h2>
      ...
      <p class="text-thin terms-text">
        ...
        under the age of 18; (5) you are not a minor in the jurisdiction in which you reside, or if
        a minor, you have received parental permission to use the Site; (6) you will not access the
        Site through automated or non-human means, whether through a bot, script or otherwise; (7)
        you will not use the Site for any illegal or unauthorized purpose; and (8) your use of the
      ...
      <h2 class="text-thin subtitle">USER REGISTRATION</h2>
      ...
      <h2 class="text-thin subtitle">FEES AND PAYMENT</h2>

      <p class="text-thin terms-text">We accept the following forms of payment:</p>
      ...
      <h2 class="text-thin subtitle">FREE TRIAL</h2>
      ...
      <h2 class="text-thin subtitle">CANCELLATION</h2>

      <p class="text-thin terms-text">
        You can cancel your subscription at any time by contacting us using the contact information
        provided below. Your cancellation will take effect at the end of the current paid term.
      </p>
      <p class="text-thin terms-text">
        If you are unsatisfied with our services, please email us at support@mailcheck.co or call us
        at +44 203 807 08 08.
      </p>

      <h2 class="text-thin subtitle">PROHIBITED ACTIVITIES</h2>
      ...
      <p class="text-thin terms-text">As a user of the Site, you agree not to:</p>

      <ol class="text-thin terms-text">
        <li>
      ...
      <h2 class="text-thin subtitle">USER GENERATED CONTRIBUTIONS</h2>
      ...
      <h2 class="text-thin subtitle">CONTRIBUTION LICENSE</h2>
      ...
      <h2 class="text-thin subtitle">SUBMISSIONS</h2>
      ...
      <h2 class="text-thin subtitle">U.S. GOVERNMENT RIGHTS</h2>
      ...
      <h2 class="text-thin subtitle">SITE MANAGEMENT</h2>
      ...
      <h2 class="text-thin subtitle">PRIVACY POLICY</h2>
      ...
      <p class="text-thin terms-text">
        ...
        into these Terms of Use. Please be advised the Site is hosted in the United Kingdom. If you
        access the Site from any other region of the world with laws or other requirements governing
        personal data collection, use, or disclosure that differ from applicable laws in the United
        Kingdom, then through your continued use of the Site, you are transferring your data to the
        United Kingdom, and you agree to have your data transferred to and processed in the United
        Kingdom. Further, we do not knowingly accept, request, or solicit information from children
        or knowingly market to children. Therefore, in accordance with the U.S. Children’s Online
        Privacy Protection Act, if we receive actual knowledge that anyone under the age of 18 has
        provided personal information to us without the requisite and verifiable parental consent,
        we will delete that information from the Site as quickly as is reasonably practical.
      </p>

      <h2 class="text-thin subtitle">COPYRIGHT INFRINGEMENTS</h2>
      ...
      <h2 class="text-thin subtitle">TERM AND TERMINATION</h2>
      ...
      <h2 class="text-thin subtitle">MODIFICATIONS AND INTERRUPTIONS</h2>
      ...
      <h2 class="text-thin subtitle">GOVERNING LAW</h2>
      ...
      <p class="text-thin terms-text">
        ...
        of the law of your country of residence. OSA MANAGEMENT LLP and yourself both agree to
        submit to the non-exclusive jurisdiction of the courts of England, London, which means that
        you may make a claim to defend your consumer protection rights in regards to these
        Conditions of Use in the United Kingdom, or in the EU country in which you reside.
      </p>

      <h2 class="text-thin subtitle">DISPUTE RESOLUTION</h2>

      <p class="text-thin terms-text">Informal Negotiations</p>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">Binding Arbitration</p>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">Restrictions</p>
      <p class="text-thin terms-text">
      ...
      <p class="text-thin terms-text">Exceptions to Informal Negotiations and Arbitration</p>
      <p class="text-thin terms-text">
      ...
      <h2 class="text-thin subtitle">CORRECTIONS</h2>
      ...
      <h2 class="text-thin subtitle">LIMITATIONS OF LIABILITY</h2>
      ...
      <p class="text-thin terms-text">
        ...
        THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR __________. CERTAIN US STATE LAWS AND
      ...
      <h2 class="text-thin subtitle">INDEMNIFICATION</h2>
      ...
      <h2 class="text-thin subtitle">USER DATA</h2>
      ...
      <h2 class="text-thin subtitle">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
      ...
      <h2 class="text-thin subtitle">CALIFORNIA USERS AND RESIDENTS</h2>
      ...
      <h2 class="text-thin subtitle">MISCELLANEOUS</h2>
      ...
      <h2 class="text-thin subtitle">CONTACT US</h2>
      ...
      <p class="text-thin terms-text">Phone: +44 203 807 08 08</p>
      <p class="text-thin terms-text">support@mailcheck.co</p>
    </div>
  </div>
</main>
<ContactUs />
