    ...
    <div class="container">
        <div class="content-block">
            ...
            <p class="text-thin terms-text">
                ...
                (“you”) and OSA MANAGEMENT LLP, doing business as Mailcheck
                ("Mailcheck", “we”, “us”, or “our”), concerning your access to
                and use of the <a
                class="text-thin text-thin-link"
                href="https://www.mailcheck.co/">mailcheck.co</a> website as well as any
            ...
            <p class="text-thin terms-text">
                ...
                under the age of 18; (5) you are not a minor in the jurisdiction
            ...
            <p class="text-thin terms-text">
                ...
                support@mailcheck.co or call us at +44 203 807 08 08.
            </p>
            ...
            <p class="text-thin terms-text">
                ...
                Privacy Policy: <a
                class="text-thin text-thin-link"
                href="https://www.mailcheck.co/privacy">mailcheck.co/privacy</a>. By using the
                ...
                differ from applicable laws in the United Kingdom, then through
                your continued use of the Site, you are transferring your data
                to the United Kingdom, and you agree to have your data
                transferred to and processed in the United Kingdom. Further, we
                ...
                18 has provided personal information to us without the requisite
            ...
            <p class="text-thin terms-text">
                ...
                country of residence. OSA MANAGEMENT LLP and yourself both agree
                to submit to the non-exclusive jurisdiction of the courts of
                England, London, which means that you may make a claim to defend
                your consumer protection rights in regards to these Conditions
                of Use in the United Kingdom, or in the EU country in which you
                reside.
            </p>
            ...
            <p class="text-thin terms-text">
                ...
                acceptance. The seat of arbitration shall be London, United
                Kingdom. The language of the proceedings shall be English.
