...
![MailChimp integration step 1: Connect](/src/routes/mailchimp-integration/step1.jpg)

### Step 2:

- Log in your Mailchimp account

![MailChimp integration step 2.1: Log in your Mailchimp account](/src/routes/mailchimp-integration/step2.jpg)

- Allow Mailcheck to view Mailchimp data

![MailChimp integration step 2.1: Allow Mailcheck to view Mailchimp data](/src/routes/mailchimp-integration/step2-1.jpg)

### Step 3:

- Once the account connected enter Integration to start the validation process:

![MailChimp integration step 3: Once the account connected enter Integration to start the validation process](/src/routes/mailchimp-integration/step3.jpg)
...
![MailChimp integration step 4: Click “Process” to start the validation operation](/src/routes/mailchimp-integration/step4.jpg)
...
![MailChimp integration step 5: see the progress of the validation](/src/routes/mailchimp-integration/step5.jpg)
...
![MailChimp integration step 6: Choose all contacts](/src/routes/mailchimp-integration/step6.jpg)
...
![MailChimp integration step 7: Click 'Toggle columns' and choose from the dropdown menu 'Mailcheck Score', 'Mailcheck Status', 'Mailcheck Date'](/src/routes/mailchimp-integration/step7.jpg)

### Step 8:

- _Now you can see the results_

![MailChimp integration step 8: see the results](/src/routes/mailchimp-integration/step8.jpg)
...
![MailChimp integration step 9: filter your data in Mailchimp](/src/routes/mailchimp-integration/step9.jpg)
...
![MailChimp integration step 9.1: Mailcheck Statuses Valid/Invalid/Risky](/src/routes/mailchimp-integration/step9-1.jpg)

- I’ve decided to choose “invalid” so I could unsubscribe them from emailing list

![MailChimp integration step 9.2: unsubscribe 'invalid' emails](/src/routes/mailchimp-integration/step9-2.jpg)
