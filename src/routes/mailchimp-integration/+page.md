...
![MailChimp integration step 1: Connect](./step1.jpg?enhanced)

### Step 2:

- Log in your Mailchimp account

![MailChimp integration step 2.1: Log in your Mailchimp account](./step2.jpg?enhanced)

- Allow Mailcheck to view Mailchimp data

![MailChimp integration step 2.1: Allow Mailcheck to view Mailchimp data](./step2-1.jpg?enhanced)

### Step 3:

- Once the account connected enter Integration to start the validation process:

![MailChimp integration step 3: Once the account connected enter Integration to start the validation process](./step3.jpg?enhanced)
...
![MailChimp integration step 4: Click “Process” to start the validation operation](./step4.jpg?enhanced)
...
![MailChimp integration step 5: see the progress of the validation](./step5.jpg?enhanced)
...
![MailChimp integration step 6: Choose all contacts](./step6.jpg?enhanced)
...
![MailChimp integration step 7: Click 'Toggle columns' and choose from the dropdown menu 'Mailcheck Score', 'Mailcheck Status', 'Mailcheck Date'](./step7.jpg?enhanced)

### Step 8:

- _Now you can see the results_

![MailChimp integration step 8: see the results](./step8.jpg?enhanced)
...
![MailChimp integration step 9: filter your data in Mailchimp](./step9.jpg?enhanced)
...
![MailChimp integration step 9.1: Mailcheck Statuses Valid/Invalid/Risky](./step9-1.jpg?enhanced)

- I’ve decided to choose “invalid” so I could unsubscribe them from emailing list

![MailChimp integration step 9.2: unsubscribe 'invalid' emails](./step9-2.jpg?enhanced)
