    ...
    <div class="container">
        <div class="content-block">
            ...
            <p class="text-thin terms-text">
                This Cookie Policy explains how OSA Management LLP ("Company",
                ...
                <a
                    ...
                    href="https://www.mailcheck.co/">mailcheck.co</a>,
            ...
            <p class="text-thin terms-text">
                Cookies set by the website owner (in this case, OSA Management
                LLP) are called "first party cookies". Cookies set by parties
            ...
            <p class="text-thin terms-text">
                ...
                <a
                    class="text-thin text-thin-link"
                    href="http://www.aboutads.info/choices/">aboutads.info</a>
                or
                <a
                    class="text-thin text-thin-link"
                    href="http://www.youronlinechoices.com">youronlinechoices.com</a>.
            </p>
            <p class="text-thin terms-text">
                The specific types of first and third party cookies served
                through our Websites and the purposes they perform are described
            ...
            <p class="text-thin terms-text">
                Purpose: Used by Cloudflare to identify individual clients
                behind a shared IP address, and apply security settings on a
                per-client basis. This is a HTTP type cookie that expires after
                1 year.
            </p>
            ...
            <p class="text-thin terms-text">
                <a
                    class="text-thin text-thin-link"
                    href="https://www.cloudflare.com/privacypolicy/">Service: CloudFlare
            ...
            <p class="text-thin terms-text">
                Purpose: Used by Yandex Metrica as a unique user ID to help
                track a user in a website
            </p>
            <p class="text-thin terms-text">Provider: www.mailcheck.co</p>
            <p class="text-thin terms-text">
                Service: Metrica <a class="text-thin text-thin-link" href="https://yandex.com/legal/privacy/">View Service Privacy Policy</a>
            </p>
            <p class="text-thin terms-text">Country: United States</p>
            ...
            <p class="text-thin terms-text">
                Purpose: Used by Yandex Metrica to determine if a visitor has ad
                blockers installed in their browsers
            </p>
            <p class="text-thin terms-text">Provider: .mailcheck.co</p>
            <p class="text-thin terms-text">
                Service: Metrica <a class="text-thin text-thin-link" href="https://yandex.com/legal/privacy/">View Service Privacy Policy</a>
            ...
            <p class="text-thin terms-text">
                Purpose: Used by Yandex Metrica for identifying site users. This
                cookie exists for a period of 1 year maximum.
            </p>
            <p class="text-thin terms-text">Provider: .yandex.ru</p>
            <p class="text-thin terms-text">
                Service: Yandex <a class="text-thin text-thin-link" href="https://yandex.com/legal/privacy/">View Service Privacy Policy</a>
            </p>
            ...
            <p class="text-thin terms-text">
                Purpose: Used by Yandex Metrica to determine the date of the
                user's first site session.
            </p>
            <p class="text-thin terms-text">Provider: .mailcheck.co</p>
            <p class="text-thin terms-text">
                Service: Metrica <a class="text-thin text-thin-link" href="https://yandex.com/legal/privacy/">View Service Privacy Policy</a>
            ...
            <p class="text-thin terms-text">
                Purpose: Used by Facebook to collect a unique browser and user
                ID, used for targeted advertising.
            </p>
            <p class="text-thin terms-text">Provider: .facebook.com</p>
            <p class="text-thin terms-text">
                Service: <a class="text-thin text-thin-link" href="https://www.facebook.com/privacy/explanation">Facebook View Service Privacy Policy</a>
            </p>
            ...
            <p class="text-thin terms-text">
                Purpose: Facebook tracking pixel used to identify visitors for
            ...
            <p class="text-thin terms-text">
                _We may update this Cookie Policy from time to time in order to
            ...
            <p class="text-thin terms-text">
                ...
                technologies, please email us at s@mailcheck.co or by post to:
            </p>
